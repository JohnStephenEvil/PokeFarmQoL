...
class Globals {
    ...
    static SHELTER_TYPE_TABLE = ["0","Normal","<img src='https://static.pokefarm.com/img/types/normal.png'>","1","Fire","<img src='https://static.pokefarm.com/img/types/fire.png'>","2","Water","<img src='https://static.pokefarm.com/img/types/water.png'>","3","Electric","<img src='https://static.pokefarm.com/img/types/electric.png'>","4","Grass","<img src='https://static.pokefarm.com/img/types/grass.png'>","5","Ice","<img src='https://static.pokefarm.com/img/types/ice.png'>","6","fighting","<img src='https://static.pokefarm.com/img/types/fighting.png'>","7","Poison","<img src='https://static.pokefarm.com/img/types/poison.png'>","8","Ground","<img src='https://static.pokefarm.com/img/types/ground.png'>","9","Flying","<img src='https://static.pokefarm.com/img/types/flying.png'>","10","Psychic","<img src='https://static.pokefarm.com/img/types/psychic.png'>","11","Bug","<img src='https://static.pokefarm.com/img/types/bug.png'>","12","Rock","<img src='https://static.pokefarm.com/img/types/rock.png'>","13","Ghost","<img src='https://static.pokefarm.com/img/types/ghost.png'>","14","Dragon","<img src='https://static.pokefarm.com/img/types/dragon.png'>","15","Dark","<img src='https://static.pokefarm.com/img/types/dark.png'>","16","Steel","<img src='https://static.pokefarm.com/img/types/steel.png'>","17","Fairy","<img src='https://static.pokefarm.com/img/types/fairy.png'>"];
    ...
    static SHELTER_SEARCH_DATA = [
        "findNewEgg","Egg","new egg","<img src='https://static.pokefarm.com/img/pkmn/egg.png'>",
        "findNewPokemon","Pokémon","new Pokémon","<img src='https://static.pokefarm.com/img/pkmn/pkmn.png'>",
        "findShiny","SHINY","Shiny","<img src='https://static.pokefarm.com/img/pkmn/shiny.png'>",
        "findAlbino","ALBINO","Albino","<img src='https://static.pokefarm.com/img/pkmn/albino.png'>",
        "findMelanistic","MELANISTIC","Melanistic","<img src='https://static.pokefarm.com/img/pkmn/melanistic.png'>",
        "findPrehistoric","PREHISTORIC","Prehistoric","<img src='https://static.pokefarm.com/img/pkmn/prehistoric.png'>",
        "findDelta","DELTA","Delta","<img src='https://static.pokefarm.com/img/pkmn/_delta/dark.png'>",
        "findMega","MEGA","Mega","<img src='https://static.pokefarm.com/img/pkmn/mega.png'>",
        "findStarter","STARTER","Starter","<img src='https://static.pokefarm.com/img/pkmn/starter.png'>",
        "findCustomSprite","CUSTOM SPRITE","Custom Sprite","<img src='https://static.pokefarm.com/img/pkmn/cs.png'>",
        "findMale","[M]","Male","<img src='https://static.pokefarm.com/img/pkmn/gender_m.png'>",
        "findFemale","[F]","Female","<img src='https://static.pokefarm.com/img/pkmn/gender_f.png'>",
        "findNoGender","[N]","Genderless","<img src='https://static.pokefarm.com/img/pkmn/gender_n.png'>",
        "findLegendary","","Legendary","<img src='https://static.pokefarm.com/img/pkmn/pkmn.png'>",
        "findUltraBeast","","Ultra Beast","<img src='https://static.pokefarm.com/img/items/summon_nih.png' style='width:20px;vertical-align:bottom;'>",
        "findTotem","TOTEM","Totem","<img src='https://static.pokefarm.com/img/pkmn/totem.png'>",
        "findWalker","Pokéwalker","Pokéwalker Pokémon","<img src='https://static.pokefarm.com/img/pkmn/walker.png'>",
        "findGarden","GARDEN","Garden Pokémon","<img src='https://pokefarm.com/img/pkmn/berrygarden.png'>"
    ];
    ...
    static SHELTER_SEARCH_LISTS = {
        "findLegendary":[
            ...
            // Alola
            /*"Type: Null","Silvally",*/"Tapu Koko","Tapu Lele","Tapu Bulu","Tapu Fini","Cosmog","Cosmoem","Solgaleo","Lunala","Necrozma","Magearna","Marshadow","Zeraora","Melmetal",
            // Ultra Beasts
        ...
        "findUltraBeast":[
            "Type: Null","Silvally","Nihilego","Buzzwole","Pheromosa","Xurkitree","Celesteela","Kartana","Guzzlord","Poipole","Naganadel","Stakataka","Blacephalon",
        ]
    };
        ...
        if (enabled) {
            ...
            for (let i = 0; i < typesArrayNoEmptySpace.length; i++) {
                ...
                if (amountOfTypesFound.length > 1) {
                    document.querySelector('#labsuccess').insertAdjacentHTML('beforeend', '<div id="labfound">' + amountOfTypesFound.length + ' ' + foundType + ' egg types found! (' + typePokemonNames.toString().split(',').join(', ') + ')</div>');
...
class ShelterPage extends Page {
    ...
    customSearch() {
         ...
         */
            ...
            if (this.settings.findUltraBeast === true) {
                this.searchForTooltipText('findUltraBeast');
            }
            if (this.settings.findTotem === true) {
                this.searchForImgTitle('findTotem');
            }
            if (this.settings.findWalker === true) {
                this.searchForImgTitle('findWalker');
            }
            if (this.settings.findGarden === true) {
                this.searchForImgTitle('findGarden');
            }
